...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/realobjectbank/flexsearch.min.js');loadScript('/realobjectbank/en.search-data.min.8a6b01b04556760fc56af82a1d9a6dfa38f752c5e1b2d788fadb05ae42ba6d7d.js',function(){input.required=false;search();});}
